...
ASSETS_PATH = OUTPUT_PATH / Path(r"C:\Users\your-username\Documents\SoftwareDev\Versions\Ver_9\assets\frame11") # This path is used in order for the file to recognise any assets that will be used
...
window.title('Register') # Makes the title of the window/file: "Register"
