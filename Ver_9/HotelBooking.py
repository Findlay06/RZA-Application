...
ASSETS_PATH = OUTPUT_PATH / Path(r"C:\Users\your-username\Documents\SoftwareDev\Versions\Ver_9\assets\frame7")
...
def msgbox_checkout(): # Message box function
    messagebox.showinfo("Notification", "API implementation not done!") # Will display a messagebox displaying the two strings provided.
...
window.title('Hotel Booking') # Makes the title of the window/file: "Hotel Booking"
...
canvas.create_text(
    ...
    140.0,
    anchor="nw",
    text="Hotel Booking will allow you to pay the day\n",
    fill="#FFFFFF",
