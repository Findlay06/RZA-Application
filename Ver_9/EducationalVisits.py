...
ASSETS_PATH = OUTPUT_PATH / Path(r"C:\Users\your-username\Documents\SoftwareDev\Versions\Ver_9\assets\frame4")
...
def materials(url): # Is a function for url paths, will be used to direct users once a button is clicked
...
window.title('Educational Visits') # Makes the title of the window/file: "Educational Visits"
...
window.iconphoto(False, firsticon) # Implements the icon provided in line 27
...
canvas.create_text(
    ...
    307.0,
    anchor="nw",
    text="Advice related to animals.",
    fill="#FFFFFF",
    font=("ABeeZee Regular", 16 * -1)
)
...
canvas.create_text(
    ...
    335.0,
    anchor="nw",
    text="Facility open/close times.",
    fill="#FFFFFF",
    font=("ABeeZee Regular", 16 * -1)
)
...
button_2 = Button(
    ...
    borderwidth=0,
    highlightthickness=0,
    command=lambda: materials ('https://www.chesterzoo.org/schools/at-the-zoo-education/'), # Directs the user to this url once the button ic clicked
    relief="flat"
)
button_2.place(
    x=139.0,
