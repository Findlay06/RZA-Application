...
ASSETS_PATH = OUTPUT_PATH / Path(r"C:\Users\your-username\Documents\SoftwareDev\Versions\Ver_9\assets\frame8") # This path is used in order for the file to recognise any assets that will be used
...
def msgbox_hotel_availability(): # Message box function
    messagebox.showinfo("Notification", "There are currently 4 rooms available.")  # Will display messagebox with the two includes strings.
...
window.title('Hotel Availability') # Makes the title of the window/file: "Hotel Availability"
...
button_2 = Button(
    ...
    borderwidth=0,
    highlightthickness=0,
    command=lambda: msgbox_hotel_availability(),
    relief="flat"
)
button_2.place(
    x=33.0,
...
canvas.create_text(
    ...
    140.0,
    anchor="nw",
    text="Hotel Availability will allow you to check if\n",
    fill="#FFFFFF",
